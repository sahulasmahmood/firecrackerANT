...
const leadRoutes = require('./online/leadRoutes');

// Compliance routes
const licenseRoutes = require('./compliance/licenseRoutes');
...
router.use('/online/leads', leadRoutes); // Lead/Enquiry management
...
// Compliance routes
router.use('/compliance/licenses', licenseRoutes);
