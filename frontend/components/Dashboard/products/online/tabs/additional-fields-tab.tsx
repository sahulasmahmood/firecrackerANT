    ...
    <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Allow customers to return this product (Usually NO for firecrackers)
                </p>
              </div>
              <Switch
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="Enter storage or safety instructions (e.g., Store in a cool, dry place. Keep away from children.)"
          className="mt-2 min-h-[100px]"
        />
        <p className="text-sm text-muted-foreground mt-1">
          Describe storage instructions, safety warnings, or warranty terms
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {formData.warrantyDetails && (
            <div className="p-4 bg-gray-50 rounded-lg md:col-span-2">
              <p className="text-sm text-muted-foreground">Storage / Safety / Warranty</p>
          ...
          <div className="space-y-2">
            ...
            {formData.warrantyDetails && (
              <div className="flex items-center gap-2 text-sm text-blue-800">
                ...
                <span>Safety/Storage info included</span>
              </div>
            )}
            <div className="flex items-center gap-2 text-sm text-blue-800">
              <svg
